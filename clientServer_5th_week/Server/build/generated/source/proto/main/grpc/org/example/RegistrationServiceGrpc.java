...
public final class RegistrationServiceGrpc {
  ...
  public static final String SERVICE_NAME = "org.example.RegistrationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<org.example.Request,
      org.example.Response> getRegistrationMethod;
  ...
  public static io.grpc.MethodDescriptor<org.example.Request,
      org.example.Response> getRegistrationMethod() {
    io.grpc.MethodDescriptor<org.example.Request, org.example.Response> getRegistrationMethod;
    if ((getRegistrationMethod = RegistrationServiceGrpc.getRegistrationMethod) == null) {
      synchronized (RegistrationServiceGrpc.class) {
        if ((getRegistrationMethod = RegistrationServiceGrpc.getRegistrationMethod) == null) {
          RegistrationServiceGrpc.getRegistrationMethod = getRegistrationMethod =
              ...
              .setSchemaDescriptor(new RegistrationServiceMethodDescriptorSupplier("registration"))
              .build();
        }
      }
    }
  ...
  public static abstract class RegistrationServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void registration(org.example.Request request,
        io.grpc.stub.StreamObserver<org.example.Response> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getRegistrationMethod(), responseObserver);
    }
  ...
  public static final class RegistrationServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<RegistrationServiceBlockingStub> {
    ...
    /**
     */
    public org.example.Response registration(org.example.Request request) {
  ...
  public static final class RegistrationServiceFutureStub extends io.grpc.stub.AbstractFutureStub<RegistrationServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<org.example.Response> registration(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REGISTRATION:
          serviceImpl.registration((org.example.Request) request,
              (io.grpc.stub.StreamObserver<org.example.Response>) responseObserver);
          break;
        default:
